...
public class StepDetector {
    ...
    public void updateAccel(Data sample) {
        ...
        if (velocityEstimate > STEP_THRESHOLD && oldVelocityEstimate <= STEP_THRESHOLD
                && (sample.getTimestamp() - lastStepTimeNs > STEP_DELAY_NS)) {
            listener.step(sample.getTimestamp());
            lastStepTimeNs = sample.getTimestamp();
        }
